...
ACLOCAL = ${SHELL} /cygdrive/c/sqlite/sqlite/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /cygdrive/c/sqlite/sqlite/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /cygdrive/c/sqlite/sqlite/missing --run autoconf
AUTOHEADER = ${SHELL} /cygdrive/c/sqlite/sqlite/missing --run autoheader
AUTOMAKE = ${SHELL} /cygdrive/c/sqlite/sqlite/missing --run automake-1.9
AWK = gawk
BUILD_CFLAGS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /cygdrive/c/sqlite/sqlite/missing --run makeinfo
...
install_sh = /cygdrive/c/sqlite/sqlite/install-sh
